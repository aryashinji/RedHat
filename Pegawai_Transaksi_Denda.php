    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          ?>
          <form method="POST" action="insert_Denda.php">
			...
			<div class="form-group">
              ...
              <select class="form-control" name='Nama_Properti'>
               <?php
                    include "Oracle.php";
                    $rows = $db->query("Select * from denda")->fetchAll(); // multiple rows
                    foreach((array)$rows as $row) {
                      $Nama_Properti = $row['NAMA_PROPERTI'];
					  
                      echo "<option ";
					  if(isset($_GET['Nama_Properti']))
							if($Nama_Properti == $_GET['Nama_Properti']) echo 'selected';
					  echo " value='$Nama_Properti'>"."$Nama_Properti"."</option>";
                    }
                    ?>
					</select>
            </div>

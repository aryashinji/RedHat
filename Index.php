    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          ?>
          <form method="POST" action="insert_Reservasi.php">
		  <div class="form-group">
              <label class="control-label">ID Pemesan</label>
              <div class="controls">
            ...
            <div class="form-group">
              <label class="control-label">Waktu Pemesanan (hh) </label>
             <div class="controls">
                <input class="form-control" type="text" name="Waktu_Pesan">
			</div>
			<div class="form-group">
              <label class="control-label">Jumlah Pemesan</label>
              <div class="controls">
